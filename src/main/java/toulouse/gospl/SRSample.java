...
public class SRSample {
	...
	private static final String ALGO = "On verra";
	static int targetPopulation = 479553;
	
	// Output file path 
	final static Path outputPath = Paths.get("src/main/java/toulouse/gospl/output/SRNoSample_export.csv"); 
	final static Path reportPath = Paths.get("src/main/java/toulouse/gospl/output/SRNoSample_report.csv");
	final static Path statPath = Paths.get("src/main/java/toulouse/gospl/output/SRNoSample_stat.csv");
	// Configuration file path
	final static Path confFile = Paths.get("src/main/java/toulouse/gospl/data/toulouse_demographics.gns");
