...
public class HS {
	...
	public static void main(String[] args) {
		...
		final ISyntheticReconstructionAlgo<IHierarchicalSampler> distributionInfAlgo = new HierarchicalHypothesisAlgo();
		ISampler<ACoordinate<APopulationAttribute, APopulationValue>> sampler = null;
		try {
			sampler = distributionInfAlgo.inferSRSampler(distribution, new GosplHierarchicalSampler());
		} catch (final IllegalDistributionCreation e1) {
			e1.printStackTrace();
		}
