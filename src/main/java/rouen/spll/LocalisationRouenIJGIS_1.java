...
import spll.popmapper.distribution.AreaSpatialDistribution;
import spll.popmapper.distribution.NumberDensitySpatialDistribution;
...
public class LocalisationRouenIJGIS_1 {
	...
	public static void main(String[] args) {
		...
		localizer.getLocalizationConstraint().setIncreaseStep(50.0);
		localizer.getLocalizationConstraint().setMaxIncrease(100.0); 
		
	//	AreaSpatialDistribution dist = new AreaSpatialDistribution();
	//	localizer.setCandidatesDistribution(dist);
		...
		//NumberDensitySpatialDistribution co = new NumberDensitySpatialDistribution(maxDens);
		//localizer.setCandidatesDistribution(co);
		// SETUP REGRESSION
		try {
